...
exports.validator = exports.profiler = exports.logger = exports.http = exports.tokenExpiry = exports.appKey = void 0;
const proxy_addr_1 = __importDefault(require("proxy-addr"));
const Env_1 = __importDefault(global[Symbol.for('ioc.use')]("Adonis/Core/Env"));
exports.appKey = Env_1.default.get('APP_KEY');
exports.tokenExpiry = Env_1.default.get('TOKEN_EXPIRY');
exports.http = {
